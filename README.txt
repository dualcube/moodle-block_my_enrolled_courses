My Enrolled Courses block enables users to show or hide the courses they are enrolled in. The block contains links to the courses enrolled, 
...
To install, place all files in /blocks/my_enrolled_courses and visit /admin/index.php in your browser.
